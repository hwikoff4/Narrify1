      ...
      <div className="relative w-full max-w-md animate-scale-in">
        ...
        <div className="relative bg-bg-secondary/90 backdrop-blur-xl rounded-3xl border border-border p-8 sm:p-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button type="button" onClick={() => handleSocialLogin('google')} className="btn-secondary py-3 flex items-center justify-center gap-2">
            ...
            <button type="button" onClick={() => handleSocialLogin('github')} className="btn-secondary py-3 flex items-center justify-center gap-2">
